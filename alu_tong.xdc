...
#set_property PACKAGE_PIN V2 [get_ports {OPC4[0]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[0]}]
#set_property PACKAGE_PIN T3 [get_ports {OPC4[1]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[1]}]
#set_property PACKAGE_PIN T2 [get_ports {OPC4[2]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[2]}]
#set_property PACKAGE_PIN R3 [get_ports {OPC4[3]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[3]}]
set_property PACKAGE_PIN W2 [get_ports {OPC4[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[0]}]
set_property PACKAGE_PIN U1 [get_ports {OPC4[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[1]}]
set_property PACKAGE_PIN T1 [get_ports {OPC4[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[2]}]
set_property PACKAGE_PIN R2 [get_ports {OPC4[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {OPC4[3]}]


## LEDs
set_property PACKAGE_PIN U16 [get_ports {Aout[0]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {Aout[0]}]
set_property PACKAGE_PIN E19 [get_ports {Aout[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Aout[1]}]
set_property PACKAGE_PIN U19 [get_ports {Aout[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Aout[2]}]
set_property PACKAGE_PIN V19 [get_ports {Aout[3]}]
